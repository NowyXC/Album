...
public class DeviceUtil {
    ...
    public static boolean isSleeping(Context context) {
        ...
        Logger.t(TAG).d(isSleeping ? "手机睡眠中.." : "手机未睡眠...");
        return isSleeping;
    }
    ...
    public static boolean isPhone(Context context) {
        ...
        if (type == TelephonyManager.PHONE_TYPE_NONE) {
            Logger.t(TAG).i("Current device is Tablet!");
            return false;
        } else {
            Logger.t(TAG).i("Current device is phone!");
            return true;
        }
    }
    ...
    public static String getDeviceIMEI(Context appContext) {
        ...
        Logger.t(TAG).d("当前设备IMEI码: " + deviceId);
        return deviceId;
    }
...
//                    L.e("GetPhoneContactUtils", "电话=" + phoneString);
                    Logger.t(TAG).e("GetPhoneContactUtils", "名字=" + displayNameString);
//                    L.e("GetPhoneContactUtils", "联系人id=" + contactIdString);
                    map.put(phoneString, displayNameString);
                }
                Logger.t(TAG).e("GetPhoneContactUtils", "联系人总数=" + map.size());
            }
        } catch (Exception e) {
            Logger.t(TAG).e("GetPhoneContactUtils", e.getMessage());
        } finally {
            if (phones != null)
                phones.close();
        }
    ...
    public static void insertContacts(Context context, String name, String phone) {
        ...
        Logger.t(TAG).e("GetPhoneContactUtils", "插入数据成功=" + name);
    ...
    public static Properties collectDeviceInfo(Context context) {
        ...
        try {
            ...
            Logger.t(TAG).e("Error while collect package info", e);
        }
...
//                if (DEBUG) {
                Logger.t(TAG).d(field.getName() + " : " + field.get(null));
//                }
            } catch (Exception e) {
                Logger.t(TAG).e( "Error while collect crash info", e);
            }
        }
