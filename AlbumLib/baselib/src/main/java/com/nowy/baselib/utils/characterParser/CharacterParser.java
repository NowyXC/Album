package com.nowy.baselib.utils.characterParser;
...
public class CharacterParser {
	public static final String TAG = CharacterParser.class.getSimpleName();
	...
	private int getChsAscii(String chs) {
		...
		try {
			...
			e.printStackTrace();
			Logger.t(TAG).e("CharacterParser-->>getChsAscii", e.getMessage().toString());
		}
		return asc;
	}
